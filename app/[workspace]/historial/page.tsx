    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      {generations.length === 0 ? (
        <div className="bg-primo-surface border border-primo-border rounded-lg p-12 text-center">
          <p className="text-primo-muted mb-4">
        ...
        <div className="space-y-4">
          {generations.map((gen) => (
            <div
              key={gen.id}
              className="bg-primo-surface border border-primo-border rounded-lg p-6 fade-in"
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 text-xs text-primo-muted">
              ...
              {gen.scene_description && (
                <p className="text-sm text-primo-muted mb-4 italic">
                ...
                {Object.entries(gen.generated_images || {}).map(
                  ([styleSlug, imageUrl]) => (
                    <div key={styleSlug} className="space-y-2">
                      ...
                      <div className="aspect-[4/5] bg-primo-bg rounded-md overflow-hidden border border-primo-border">
